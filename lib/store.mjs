...
export class Store {
  constructor(directory, workspace) {
    ...
    this.data.settings={codexInstructions:'',claudeInstructions:'',orchestratorPersona:'',autoApproveSingle:false,autoApproveReadOnly:false,tokenBudget:0,balance:'auto',reviewPolicy:'multi',...(this.data.settings||{})};
