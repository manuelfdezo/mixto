...
export class Store {
  constructor(directory, workspace) {
    ...
    this.data.settings={codexInstructions:'',claudeInstructions:'',orchestratorPersona:'',autoApproveSingle:false,autoApproveReadOnly:false,tokenBudget:0,...(this.data.settings||{})};
